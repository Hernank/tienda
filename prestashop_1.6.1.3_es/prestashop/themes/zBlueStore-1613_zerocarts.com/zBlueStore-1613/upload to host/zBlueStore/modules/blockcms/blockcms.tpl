...
{else}
	...
	<section class="bottom-footer col-xs-12">
		<div>
			{l s='[1] %3$s %2$s - %1$s [/1]' mod='blockcms' sprintf=['PrestaShop™', 'Y'|date, '©'] tags=['<a class="_blank" href="http://www.prestashop.com">'] nocache} - <a href="http://www.zerocarts.com/" target="_blank" rel="nofollow">Ecommerce Website</a>
			<br/><a href="http://www.zerocarts.com/free-prestashop-themes-premium-responsive-prestashop-templates" target="_blank" rel="nofollow">Prestashop Themes</a> by ZEROCARTS
		</div>
	</section>
	{/if}
	<!-- /Block CMS module footer -->
