				...
				<div class="right-block">
					...
					<div class="button-group">
							{if ($product.id_product_attribute == 0 || (isset($add_prod_display) && ($add_prod_display == 1))) && $product.available_for_order && !isset($restricted_country_mode) && $product.customizable != 2 && !$PS_CATALOG_MODE}
								...
								{else}
									<span class="button ajax_add_to_cart_button lnk_view btn btn-default">
							...
							<a class="button lnk_view btn btn-default quick-view" href="{$product.link|escape:'html':'UTF-8'}" rel="{$product.link|escape:'html':'UTF-8'}" title="{l s='Quick view'}">
								<span><i class="icon-arrows-alt"></i></span>
							</a>
						</div>
